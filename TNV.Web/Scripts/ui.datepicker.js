...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		dayNames: ['CN', 'Th Hai', 'Th Ba', 'Th Tư', 'Th Năm', 'Th Sáu', 'Th Bảy'], // For formatting
		dayNamesShort: ['CN', 'Hai', 'Ba', 'Tư', 'Năm', 'Sáu', 'Bảy'], // For formatting
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		buttonText: 'Chọn ngày', // Text for trigger button
