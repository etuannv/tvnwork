    ...
    <table width="100%" border="0px">
        <tr>
            <td width="71%" valign="top" align="center">
                <div class="TitleNomal">THÊM MỚI BÀI VIẾT</div>
                ...
                <asp:Table Width="80%" runat="server">
                    ...
                    <asp:TableRow Height="30px">
                        ...
                        <asp:TableCell>
                            <%: Html.TextBox("NewsOrder", ViewData["NewsOrder"], new { @class = "Input1", @title = "Nhập thứ tự bài viết" })%>
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow Height="30px">
                        <asp:TableCell>
                        ...
                        <asp:TableCell>
                            <input type="file" title="Nhập ảnh đại diện" name="NewsImage" size="52" />
                        </asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
                <asp:Table Width="100%" runat="server">
                    ...
                    <asp:TableRow Height="30px">
                        <asp:TableCell align="center" ColumnSpan=2>
                                <img alt="Lưu mới bài viết" title="Lưu mới bài viết" class="ImageButton" onclick="Submitform('QuanTriHeThong','NewsWebManager','SaveAddNewsItem', '', '','', '','');"  src='<%: Url.Content("~/Content/Image/Luu.png") %>' onmouseout="this.style.opacity=100" onmouseover="this.style.opacity=0.5"/>
