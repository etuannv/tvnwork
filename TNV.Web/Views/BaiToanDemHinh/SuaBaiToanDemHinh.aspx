    ...
    <table width="100%" border="0px">
        <tr>
            ...
            <td width="71%" valign="top" align="center">
                <div class="TitleNomal">SỬA BÀI TOÁN ĐẾM HÌNH</div>
                ...
                <%: Html.Hidden("MaBaiToan", ViewData["MaBaiToan"])%>
                <asp:Table ID="Table1" Width="98%" runat="server">
                    ...
                    <asp:TableRow Height="30px">
                        <asp:TableCell align="center">
                                <img alt="Lưu sửa bài toán" title="Lưu sửa bài toán" class="ImageButton" onclick="Submitform('QuanTriHeThong','BaiToanDemHinh','LuuSuaBaiToanDemHinh', '', '','', '','');"  src='<%: Url.Content("~/Content/Image/Luu.png") %>' onmouseout="this.style.opacity=100" onmouseover="this.style.opacity=0.5"/>
