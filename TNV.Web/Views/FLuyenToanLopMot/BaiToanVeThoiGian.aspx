                ...
                <div class="qholder">
                    ...
                    <script type="text/javascript">
                        ...
                        jQuery(document).ready(function () {
                            ...
                            var RequestUrl = '/FLuyenToanLopMot/GetOneBaiToanVeThoiGian/' + thuockhoilop + '/' + phamvi + '/' + phanloaidayso;
                            ajaxGetBaiToanThoiGian(RequestUrl, $('#question-content'), $('#incorrect-dialog'));
                        });
