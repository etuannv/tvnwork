            ...
            <div class="span10 col-lg">
                <div class="qholder">
                    <div style="margin-bottom: 10px;" class="bc bc-math">
                        ...
                        <span class="bc-item"><b><a href="/FLuyenToanLopMot/BaiToanDemHinh/<%=ViewData["ThuocKhoiLop"] %>/<%=ViewData["PhanLoaiBaiToan"] %>">Bài toán đếm hình</a></b></span>
                    </div>
                    <div>
                    ...
                    <script type="text/javascript">
                        ...
                        jQuery(document).ready(function () {
                            ...
                            var RequestUrl = '/FLuyenToanLopMot/GetOneBaiToanDemHinh/' + thuockhoilop + '/' + phanloaibaitoan;
                            ajaxGetBaiToanDemHinh(RequestUrl, $('#question-content'), $('#incorrect-dialog'));
                        });
