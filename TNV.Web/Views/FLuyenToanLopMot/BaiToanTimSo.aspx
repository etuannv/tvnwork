            ...
            <div class="span10 col-lg">
                <div class="qholder">
                    <div style="margin-bottom: 10px;" class="bc bc-math">
                        ...
                        <span class="bc-item"><b><a href="/FLuyenToanLopMot/BaiToanDaySo/<%=ViewData["ThuocKhoiLop"] %>/<%=ViewData["PhamVi"] %>/<%=ViewData["PhanLoaiBaiToan"] %>">Bài toán tìm số</a></b></span>
                    </div>
                    <div>
                        <div class="question" id="question">
                            <input type="hidden" id="hdfKhoiLop" value="<%=ViewData["ThuocKhoiLop"] %>" />
                            <input type="hidden" id="hdfPhamVi" value="<%=ViewData["PhamVi"] %>" />
                            <input type="hidden" id="hdfPhanLoaiBaiToan" value="<%=ViewData["PhanLoaiBaiToan"] %>" />
                    ...
                    <script type="text/javascript">
                        ...
                        jQuery(document).ready(function () {
                            ...
                            var phanloaibaitoan = $('#hdfPhanLoaiBaiToan').val();

                            var RequestUrl = '/FLuyenToanLopMot/GetOneBaiToanTimSo/' + thuockhoilop + '/' + phamvi + '/' + phanloaibaitoan;
                            ajaxGetBaiToanTimSo(RequestUrl, $('#question-content'), $('#incorrect-dialog'));
                        });
