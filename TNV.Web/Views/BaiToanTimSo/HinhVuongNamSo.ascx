        ...
        <% for (int i = 0; i <= CacDay.Length - 1; i++)
            { %>
                ...
                <td align="center" width="130px" >
                    <div class="HinhVuongNamSo">
                        <div class="HinhVuongNamSo_So1">
                        <%:CacSo[0]%>
                        </div>
                        <div class="HinhVuongNamSo_So2">
                        <%:CacSo[1]%>
                        </div>
                        <div class="HinhVuongNamSo_So3">
                        <%:CacSo[2]%>
                        </div>
                        <div class="HinhVuongNamSo_So4">
                        <%:CacSo[3]%>
                        </div>
                        <div class="HinhVuongNamSo_So5">
                        <%:CacSo[4]%>
                        </div>
                    </div>
                </td>
