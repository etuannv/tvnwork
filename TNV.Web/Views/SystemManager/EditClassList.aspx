...
<tr>
    <td width="71%" valign="top" align="center">
        <div class="TitleNomal">SỬA THÔNG TIN MỘT KHỐI LỚP</div>
        <%: Html.ValidationSummary(true, "[Thông báo: Không thể sửa được khối lớp này!]") %>
        ...
        <asp:Table ID="Table1" runat="server" Width="70%">
            ...
            <asp:TableRow Height="30px">
                <asp:TableCell align="center" ColumnSpan=2>
                        <img alt="Lưu sửa một khối lớp" title="Lưu sửa một khối lớp" class="ImageButton" onclick="Submitform('QuanTriHeThong','SystemManager','SaveEditClassList', '', '','','','');"  src='<%: Url.Content("~/Content/Image/Luu.png") %>' onmouseout="this.style.opacity=100" onmouseover="this.style.opacity=0.5"/>
