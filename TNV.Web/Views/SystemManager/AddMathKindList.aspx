...
<tr>
    <td width="71%" valign="top" align="center">
        <div class="TitleNomal">THÊM MỚI MỘT DẠNG TOÁN</div>
        <%: Html.ValidationSummary(true, "[Thông báo: Không thêm mới được dạng toán này!]") %>
        ...
        <asp:Table ID="Table1" runat="server" Width="70%">
            ...
            <asp:TableRow Height="30px">
                <asp:TableCell align="center" ColumnSpan=2>
                        <img alt="Lưu mới một dạng toán" title="Lưu mới một dạng toán" class="ImageButton" onclick="Submitform('QuanTriHeThong','SystemManager','SaveAddMathKindList', '', '','','','');"  src='<%: Url.Content("~/Content/Image/Luu.png") %>' onmouseout="this.style.opacity=100" onmouseover="this.style.opacity=0.5"/>
