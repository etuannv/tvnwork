...
<tr>
    <td width="71%" valign="top" align="center">
        <div class="TitleNomal">THÊM MỚI MỘT HUYỆN, THÀNH PHỐ, THỊ XÃ</div>
        <%: Html.ValidationSummary(true, "[Thông báo: Không thêm mới thông tin huyện, thành phố, thị xã này!]") %>
        <asp:Table ID="Table1" runat="server" Width="70%">
            ...
            <asp:TableRow Height="30px">
                <asp:TableCell align="center" ColumnSpan=2>
                        <img class="ImageButton" onclick="Submitform('QuanTriHeThong','ProDis','SaveAddDistrict', '', '','','','');"  src='<%: Url.Content("~/Content/Image/Luu.png") %>' onmouseout="this.style.opacity=100" onmouseover="this.style.opacity=0.5"/>
