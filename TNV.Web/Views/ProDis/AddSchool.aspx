...
<tr>
    <td width="71%" valign="top" align="center">
        <div class="TitleNomal">THÊM MỚI MỘT TRƯỜNG HỌC</div>
        <%: Html.ValidationSummary(true, "[Thông báo: Không thêm mới thông tin trường học này!]") %>
        <asp:Table ID="Table1" runat="server" Width="70%">
            <asp:TableRow Height="30px">
                ...
                <asp:TableCell height="30px">
                    <%: Html.DropDownList("MaTinhTP", (SelectList)ViewData["DsTinhTP"], new { onchange = "Submitform('QuanTriHeThong','ProDis','AddSchool', '', '','', '','');", @style = "width:255px;" })%>
            ...
            <asp:TableRow Height="30px">
                <asp:TableCell align="center" ColumnSpan=2>
                        <img class="ImageButton" onclick="Submitform('QuanTriHeThong','ProDis','SaveAddSchool', '', '','','','');"  src='<%: Url.Content("~/Content/Image/Luu.png") %>' onmouseout="this.style.opacity=100" onmouseover="this.style.opacity=0.5"/>
