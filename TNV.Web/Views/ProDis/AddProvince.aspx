...
<tr>
    <td width="71%" valign="top" align="center">
        <div class="TitleNomal">THÊM MỚI MỘT TỈNH, THÀNH PHỐ</div>
        <%: Html.ValidationSummary(true, "[Thông báo: Không thêm mới thông tỉnh, thành phố này!]") %>
        <asp:Table ID="Table1" runat="server" Width="70%">
            ...
            <asp:TableRow Height="30px">
                <asp:TableCell align="center" ColumnSpan=2>
                        <img class="ImageButton" onclick="Submitform('QuanTriHeThong','ProDis','SaveAddProDis', '', '','','','');"  src='<%: Url.Content("~/Content/Image/Luu.png") %>' onmouseout="this.style.opacity=100" onmouseover="this.style.opacity=0.5"/>
