...
<script runat="server">        
	...
	public override void SetConfig()
	{
        ...
        UserFilesPath = "~/Content/UpLoads/";                 
		// The connector tries to resolve the above UserFilesPath automatically.
		// Use the following setting it you prefer to explicitely specify the
		// absolute path. Examples: 'C:\\MySite\\userfiles\\' or '/root/mysite/userfiles/'.
		// Attention: The above 'UserFilesPath' URL must point to the same directory.        
        UserFilesAbsolutePath = HttpContext.Current.Server.MapPath("~/Content/UpLoads/");    
        ...
        TypeConfig["File"].FilesPath = "%UserFilesPath%FileUploads/";
        TypeConfig["File"].FilesAbsolutePath = (UserFilesAbsolutePath == "" ? "" : "%UserFilesAbsolutePath%FileUploads/");
		...
		TypeConfig[ "Image" ].FilesPath					= "%UserFilesPath%ImageUploads/";
        TypeConfig[ "Image" ].FilesAbsolutePath = (UserFilesAbsolutePath == "" ? "" : "%UserFilesAbsolutePath%ImageUploads/");
        ...
        TypeConfig["Flash"].FilesPath = "%UserFilesPath%FlashUploads/";
        TypeConfig["Flash"].FilesAbsolutePath = (UserFilesAbsolutePath == "" ? "" : "%UserFilesAbsolutePath%FlashUploads/");
        ...
        TypeConfig["Media"].FilesPath = "%UserFilesPath%MediaUploads/";
        TypeConfig["Media"].FilesAbsolutePath = (UserFilesAbsolutePath == "" ? "" : "%UserFilesAbsolutePath%MediaUploads/");
