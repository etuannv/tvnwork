...
FCKConfig.Plugins.Add('addbuttondemo');
FCKConfig.Plugins.Add('ajaxPost');
FCKConfig.Plugins.Add('insertvariables');
FCKConfig.Plugins.Add('ajaxAutoSave');
FCKConfig.Plugins.Add('FormulaEditor');
...
FCKConfig.ToolbarSets["Default"] = [
    ['OnlineVideo', 'FormulaEditor', 'googlemaps', 'Image', 'Flash', 'Table', 'Rule', 'Smiley', 'SpecialChar', 'PageBreak', 'Source'],
    ['Form', 'Checkbox', 'Radio', 'TextField', 'Textarea', 'Select', 'Button', 'ImageButton', 'HiddenField'],
    '/',
	['DocProps', '-', 'Save', 'NewPage', 'Preview', '-', 'Templates', 'RemoveFormat'],
	['Print', 'SpellCheck', 'Blockquote'],
    ['Link', 'Unlink', 'Anchor'],
    ['FitWindow', 'ShowBlocks', '-', 'About', 'Find', 'Replace', '-', 'SelectAll'],
	
	'/',
	['Bold', 'Italic', 'Underline', 'StrikeThrough', '-', 'Subscript', 'Superscript'],
    ['JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyFull'],
    ['Undo', 'Redo', 'OrderedList', 'UnorderedList', '-', 'Outdent', 'Indent', 'TextColor', 'BGColor', 'Cut', 'Copy', 'Paste', 'PasteText', 'PasteWord'], 
...
FCKConfig.ToolbarSets["Basic"] = [
	['Source', 'Bold', 'Italic', '-', 'OrderedList', 'UnorderedList', 'Table'], ['JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyFull'], ['Style', 'FontFormat', 'FontName', 'FontSize']
] ;
...
FCKConfig.FlashBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Flash&Connector='
    + encodeURIComponent(FCKConfig.BasePath + 'filemanager/connectors/' + _FileBrowserLanguage + '/connector.' 
